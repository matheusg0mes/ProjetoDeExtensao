...
import modulo_login
from sistemaSemiFinal.app_funcionario import JanelaFuncionario
...
class LoginFunc(ctk.CTkFrame):
    ...
    def validar_login_func(self):
        import sys
        from app_funcionario import JanelaFuncionario
        ...
        if usuario == modulo_login.usuarioFunc and senha == modulo_login.senhaFunc:
            ...
            funcionario_app = JanelaFuncionario()
            funcionario_app.mainloop()
            sys.exit()
        else:
